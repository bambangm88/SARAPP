...
public class updateData extends AppCompatActivity {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isEmpty(cekNIM) || isEmpty(cekNama) || isEmpty(cekJurusan)){
                    ...
                    data_model setMahasiswa = new data_model();
                    setMahasiswa.setLat(nimBaru.getText().toString());
                    setMahasiswa.setNama(namaBaru.getText().toString());
                    setMahasiswa.setLongi(jurusanBaru.getText().toString());
    ...
    private void updateMahasiswa(data_model mahasiswa){
